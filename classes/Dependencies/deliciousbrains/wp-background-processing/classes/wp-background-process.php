...
/**
 * Abstract MaiPerformanceImages_WP_Background_Process class.
 *
 * @abstract
 * @extends MaiPerformanceImages_WP_Async_Request
 */
abstract class MaiPerformanceImages_WP_Background_Process extends MaiPerformanceImages_WP_Async_Request {
	/**
